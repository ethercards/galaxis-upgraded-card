...
const GalaxisCard = _ref => {
  ...
  React.useEffect(() => {
    if (metadata.sides && metadata.sides.length >= 1 && metadata.sides[0].originalHeight && metadata.sides[0].originalWidth) {
      ...
      console.log(originalHeight, originalWidth); // setTheImageRatio({ width: metadata.sides[0].originalWidth, height: metadata.sides[0].originalHeight })
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, loading && /*#__PURE__*/React__default["default"].createElement(spinnersReact.SpinnerCircular, {
    ...
    id: "front-span"
  }, metadata.sides && metadata.sides.length >= 1 && !metadata.sides[0].video || !metadata.sides ? /*#__PURE__*/React__default["default"].createElement("img", {
    className: "flipped-img",
