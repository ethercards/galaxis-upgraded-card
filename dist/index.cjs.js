...
const CardBack = /*#__PURE__*/React.forwardRef((_ref, imageRef) => {
  let {
    backImage,
    onClick,
    frontIsVideo,
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    style: {
      backgroundImage: !frontIsVideo || !backIsVideo ? `url(${backImage})` : 'unset'
    },
    onMouseOver: () => {
...
const GalaxisCard = _ref => {
  ...
  const [showFlipIcon, setshowFlipIcon] = React.useState(false);
  const [frontIsVideo, setfrontIsVideo] = React.useState(false);
